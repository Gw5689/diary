...
public class MemberQuery {
	...
	public final static String INSERT_MEMBER_BY_KEY; // 회원가입 쿼리
	public final static String UPDATE_MEMBER_BY_KEY; // 회원정보 수정 쿼리
	public final static String CHECK_MEMEBER_ID;
